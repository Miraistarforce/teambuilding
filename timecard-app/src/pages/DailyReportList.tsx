                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    {report.formData && (() => {
                      ...
                      const hasImage = Object.values(formData).some(
                        (value: any) => typeof value === 'string' && (value.startsWith('/uploads/daily-reports/') || value.startsWith('http'))
                      );
                      return hasImage ? (
                          ...
                          return (
                            <div key={field.id}>
                              ...
                              <div className="p-2 bg-background-sub rounded">
                                {report.formData[field.id] && (report.formData[field.id].startsWith('/uploads/daily-reports/') || report.formData[field.id].startsWith('http')) ? (
